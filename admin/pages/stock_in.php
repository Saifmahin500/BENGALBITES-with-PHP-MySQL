    ...
    <div class="container stock-container">
        <div class="card">
            <div class="card-header">
                <h4><i class="fas fa-box-open"></i> Stock In</h4>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="form-group">
                        <label><i class="fas fa-tag" style="color: var(--brand-color); margin-right: 5px;"></i> Select Product</label>
                        ...
                        <small class="form-text">Choose the product to add stock</small>
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-sort-numeric-up" style="color: var(--brand-color); margin-right: 5px;"></i> Quantity</label>
                        <div class="input-icon">
                            <i class="fas fa-cubes"></i>
                            <input type="number" name="quantity" class="form-control" placeholder="Enter quantity" required>
                        </div>
                        <small class="form-text">Enter the number of items to add</small>
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-sticky-note" style="color: var(--brand-color); margin-right: 5px;"></i> Remarks</label>
                        <div class="input-icon">
